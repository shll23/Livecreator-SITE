...
// Alle parallelen Aufrufer warten auf das gleiche Promise.
let refreshPromise: Promise<string> | null = null;

async function refreshAccessToken(): Promise<string> {
  // Wenn bereits ein Refresh laeuft - warte auf dessen Ergebnis
  if (refreshPromise) {
  ...
  try {
    ...
    // Mutex freigeben - egal ob Erfolg oder Fehler
    refreshPromise = null;
  }
}
